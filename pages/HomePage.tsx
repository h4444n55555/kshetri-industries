...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      {/* Premium Grain Logo Hero Section */}
      <HeroSection />

      <main className="flex-1 px-6 md:px-12 lg:px-24 space-y-24 pb-24 bg-background-light">
          ...
          <div className="relative group p-4">
            ...
            <div className="rounded-[2.5rem] bg-background-light shadow-clay p-4 border border-white/50 transition-transform duration-700 hover:scale-[1.02]">
              <div className="overflow-hidden rounded-[2rem] shadow-clay-inset relative">
                <img
                  src="/static-site/assets/harvest.jpg"
                  ...
                  onError={(e) => { (e.currentTarget as HTMLImageElement).src = 'https://raw.githubusercontent.com/h4444n55555/images/refs/heads/main/WhatsApp%20Image%202026-02-18%20at%208.54.51%20PM.jpg'; }}
                />
            ...
            <ClayCard className="p-12 flex flex-col items-center text-center transition-all duration-500 hover:shadow-clay-lg hover:-translate-y-2">
              <div className="w-64 h-80 rounded-[2.5rem] bg-background-light shadow-clay-inset p-4 mb-8 mx-auto">
                <img
                  ...
                  src="/static-site/assets/tojo.jpg"
                  onError={(e) => { (e.currentTarget as HTMLImageElement).src = 'https://raw.githubusercontent.com/h4444n55555/images/refs/heads/main/tojo.jpg'; }}
                />
              </div>
            ...
            <ClayCard className="p-12 flex flex-col items-center text-center transition-all duration-500 hover:shadow-clay-lg hover:-translate-y-2">
              <div className="w-64 h-80 rounded-[2.5rem] bg-background-light shadow-clay-inset p-4 mb-8 mx-auto">
                <img
                  alt="Co-Founder"
                  className="w-full h-full rounded-[2rem] object-cover shadow-sm"
                  src="/static-site/assets/hans.jpg"
                  onError={(e) => { (e.currentTarget as HTMLImageElement).src = 'https://raw.githubusercontent.com/h4444n55555/images/refs/heads/main/hans.jpg'; }}
                />
              </div>
